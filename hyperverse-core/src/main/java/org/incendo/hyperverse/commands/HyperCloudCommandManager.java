...
package org.incendo.hyperverse.commands;
...
import org.incendo.hyperverse.commands.parser.EnumParser;
import org.incendo.hyperverse.commands.parser.GameRuleParser;
import org.incendo.hyperverse.commands.parser.HyperWorldParser;
import org.incendo.hyperverse.commands.parser.WorldFlagParser;
import org.incendo.hyperverse.commands.parser.WorldStructureSettingParser;
...
public final class HyperCloudCommandManager extends BaseCommand {
    ...
    private List<String> suggestGreedyPlayerWorlds(
    ...
    private List<String> suggestStructures(
            @NonNull final CommandContext<CommandSender> context,
            @NonNull final String input
    ) {
    ...
    private List<String> suggestGreedyPlayers(
            @NonNull final CommandContext<CommandSender> context,
            @NonNull final String input
    ) {
        String[] splitInput = input.split(" ");
    ...
    private List<String> suggestGenerators(
            @NonNull final CommandContext<CommandSender> context,
            @NonNull final String input
    ) {
        if (input.contains(":")) {
    ...
    private List<String> suggestWorldTypes(
            @NonNull final CommandContext<CommandSender> context,
            @NonNull final String input
    ) {
        if (input.contains(" ")) {
    ...
    private List<String> suggestHyperWorlds(
            @NonNull final CommandContext<CommandSender> context,
            @NonNull final String input
    ) {
    ...
    public void handleList(@NonNull final CommandContext<CommandSender> context) {
        final CommandSender sender = context.getSender();
